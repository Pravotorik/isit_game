    ...
    },
{
    question: "Базовые ИТ",
    answers: [
        "Технологии БД, технологии текствого поиска поиска, web-технологии",
        "Технологии СУБД, технологии текствого поиска поиска, web-технологии",
        "Технологии БД, технологии текствого поиска поиска, web-сервисы",
        "Технологии СУБД, теехнологии текствого поиска поиска, web-сервисы"
    ],
    correct: 1,
    explanation: "Базовые информационные технологии (ИТ) ИС. Это ключевые технологические инструменты, составляющие основу построения информационных систем: Технологии баз данных (БД): Для работы со структурированной, фактографической информацией. Технологии текстового поиска: Для обработки неструктурированных или слабоструктурированных документов на естественных языках. Web-технологии: Для создания глобальных гипермедийных систем и взаимодействия в сетях."
    }, 
{
    question: "Какая из перечисленных технологий НЕ относится к базовым информационным технологиям ИС?",
    answers: [
    ...
    correct: 2,
    explanation: "К базовым ИТ ИС относятся технологии БД, текстового поиска и Web. Технологии ИИ, хотя и важны, в данном контексте не указаны как базовые."
},
{
    question: "Что из перечисленного является примером программного ресурса ИС?",
    answers: [
    ...
    correct: 1,
    explanation: "Программные ресурсы включают системное и прикладное ПО. Оборудование — технический ресурс, персонал — человеческий, XML-файлы — информационный."
},
{
    question: "Какой вид ресурсов ИС описывается как «данные о данных»?",
    answers: [
        "Информационные ресурсы",
        "Технические ресурсы",
        "Метаресурсы (метаданные)",
        "Лингвистические ресурсы"
    ],
    correct: 2,
    explanation: "Метаресурсы (метаданные) — это особый вид ресурсов, представляющий собой данные о свойствах основных информационных ресурсов."
},
{
    question: "Что характеризует интенсиональную модель предметной области?",
    answers: [
        "Конкретное, изменяющееся во времени наполнение данными",
        "Модель высокого уровня абстракции, описывающая структуру и типы сущностей",
        "Текстовые документы на естественном языке",
        "Гибкая организация данных без строгой типизации"
    ],
    correct: 1,
    explanation: "Интенсионал — это модель высокого уровня абстракции, описывающая инвариантную структуру и типы сущностей предметной области, выраженная в виде метаданных."
},
{
    question: "К какому типу моделей данных относятся реляционные базы данных?",
    answers: [
    ...
    correct: 2,
    explanation: "Реляционные БД имеют чёткую, строго типизированную организацию с явным разделением схемы (интенсионала) и данных (экстенсионала), что характерно для структурированных моделей."
},
{
    question: "Какова основная роль интенсионала в структурированной модели данных?",
    answers: [
        "Рекомендательная, носит необязательный характер",
        "Отсутствует, так как структура скрыта в данных",
        "Директивная — задаёт правила для экстенсионала",
        "Предназначена только для логического вывода новых фактов"
    ],
    correct: 2,
    explanation: "В структурированных моделях интенсионал (схема) является явным и директивным — он строго определяет правила, по которым должны быть организованы данные в экстенсионале."
    },
{
    question: "Что из перечисленного является ядром СОВРЕМЕННОЙ концепции модели данных?",
    answers: [
        "Конкретная структура уже созданной базы данных",
        "Инструмент (язык) для описания и конструирования предметной области",
        "Совокупность только операций для манипулирования данными",
        "Графическое представление бизнес-процессов"
    ],
    correct: 1,
    explanation: "Современная концепция понимает модель данных прежде всего как ИНСТРУМЕНТ (язык), состоящий из трёх компонентов: средства структурирования, операционные средства и средства поддержания целостности."
},
{
    question: "Какой компонент модели данных включает операции вставки, удаления, модификации и выборки данных?",
    answers: [
    ...
    correct: 1,
    explanation: "Операционные средства моделей данных — это языки и операции для манипулирования экстенсионалом (конкретными данными), включая DML (операции обновления) и запросы."
},
{
    question: "Что из перечисленного является примером РЕСУРСОВ ВТОРОЙ КАТЕГОРИИ (метаресурсов) в ИС?",
    answers: [
        "Список заказов клиентов в таблице БД",
        "Текст договора, загруженный в систему",
        "Схема базы данных (описание таблиц и связей)",
        "Фотография товара в каталоге"
    ],
    correct: 2,
    explanation: "Метаресурсы (метаданные) — это «данные о данных», описывающие свойства и структуру основных ресурсов. Схема БД — классический пример метаданных (интенсионала)."
},
{
    question: "Что из перечисленного НЕ является ключевым элементом процессного подхода?",
    answers: [
        "Рассмотрение организации как совокупности взаимосвязанных бизнес-процессов",
        "Наличие владельца процесса, ответственного за результат",
        "Жёсткое разделение по функциональным отделам (принцип Тейлора)",
        "Ориентация на создание ценности для потребителя"
    ],
    correct: 2,
    explanation: "Процессный подход пришёл НА СМЕНУ функционально-ориентированному управлению (принципу Тейлора), для которого как раз характерно жёсткое разделение по отделам."
},
{
    question: "Какой элемент нотации IDEF0 показывает правила и стандарты, регламентирующие выполнение функции?",
    answers: [
        "Вход (Input)",
        "Управление (Control)",
        "Выход (Output)",
    ...
    correct: 1,
    explanation: "В нотации IDEF0 интерфейсная дуга УПРАВЛЕНИЯ (Control) входит в функциональный блок СВЕРХУ и обозначает правила, стандарты, нормативы, которые регламентируют выполнение работы."
},
{
    question: "Соединение «Исключающее ИЛИ» (X) в нотации IDEF3 означает, что:",
    answers: [
        "Выполняются ВСЕ связанные ветви процесса",
        "Выполняется ОДНА ИЛИ НЕСКОЛЬКО связанных ветвей",
        "Выполняется РОВНО ОДНА из связанных ветвей",
        "Ветви не связаны между собой логически"
    ],
    correct: 2,
    explanation: "Соединение «Исключающее ИЛИ» (X или XOR) в IDEF3 означает, что выполняется РОВНО ОДНА из альтернативных ветвей процесса."
},
{
    question: "Какой элемент диаграммы DFD обозначает место хранения информации, например, базу данных?",
    answers: [
        "Процесс (Process)",
    ...
    correct: 3,
    explanation: "Хранилище данных (Data Store) в DFD изображается в виде открытого прямоугольника или двух параллельных линий и обозначает место, где данные сохраняются для последующего использования (файл, БД, архив)."
},
{
    question: "Для ИС какого уровня управления характерны высокоструктурированные, повторяющиеся и формализованные задачи?",
    answers: [
        "Стратегического уровня (EIS)",
        "Тактического уровня (DSS)",
        "Операционного (исполнительского) уровня (TPS)",
        "Корпоративного уровня (ERP)"
    ],
    correct: 2,
    explanation: "ИС операционного (исполнительского) уровня (TPS — Transaction Processing Systems) автоматизируют рутинные, повторяющиеся транзакции, которые легко формализовать."
},
{
    question: "Что из перечисленного НЕ является характерной чертой корпоративной ИС (КИС)?",
    answers: [
        "Закрытая, проприетарная архитектура",
        "Распределённая обработка данных",
        "Единое интегрированное информационное пространство",
        "Модульность и масштабируемость"
    ],
    correct: 0,
    explanation: "Корпоративные ИС, наоборот, характеризуются ОТКРЫТОЙ архитектурой, что позволяет интегрировать их с другими системами и адаптировать под нужды предприятия."
    },
{
    question: "Какая задача является СТРУКТУРИРОВАННОЙ согласно классификации по признаку структурированности?",
    answers: [
        "Разработка новой маркетинговой стратегии",
        "Выбор подрядчика для уникального проекта",
        "Расчёт заработной платы по утверждённой формуле",
        "Анализ причин падения продаж нового продукта"
    ],
    correct: 2,
    explanation: "Структурированные (формализуемые) задачи имеют точный математический алгоритм решения и носят рутинный, повторяющийся характер, как расчёт зарплаты. Цель ИС — полная автоматизация таких задач."
},
{
    question: "На каком уровне управления в организации ИС преимущественно решают НЕСТРУКТУРИРОВАННЫЕ задачи долгосрочного планирования?",
    answers: [
        "Операционном (исполнительском) уровне",
        "Тактическом (функциональном) уровне",
        "Стратегическом уровне",
        "Все уровни в равной степени"
    ],
    correct: 2,
    explanation: "ИС стратегического уровня обслуживают высшее руководство и предназначены для решения неструктурированных задач стратегического планирования в условиях неопределённости."
},
{
    question: "Какой главный недостаток характеризует ФАЙЛ-СЕРВЕРНУЮ архитектуру ИС?",
    answers: [
        "Невозможность коллективной работы с данными",
        "Высокий сетевой трафик из-за передачи «сырых» файлов данных",
        "Сложность администрирования на одном компьютере",
        "Недостаточная безопасность из-за тонких клиентов"
    ],
    correct: 1,
    explanation: "В файл-серверной архитектуре при запросе по сети передаётся весь файл данных (например, таблица), а обработка идёт на клиенте. Это создаёт очень высокий сетевой трафик."
},
{
    question: "В чем заключается ключевое отличие КЛИЕНТ-СЕРВЕРНОЙ архитектуры от файл-серверной?",
    answers: [
        "Данные хранятся на одном компьютере",
        "СУБД и обработка запросов выполняются на СЕРВЕРЕ",
        "Клиенты не имеют доступа к интерфейсу приложения",
        "Отсутствует сетевое взаимодействие"
    ],
    correct: 1,
    explanation: "В клиент-серверной архитектуре СУБД и обработка данных (поиск, фильтрация) выполняются на сервере, который передаёт клиенту только готовый результат. В файл-серверной же обработка идёт на клиенте."
},
{
    question: "Что находится в ОСНОВАНИИ аналитической пирамиды Gartner?",
    answers: [
        "OLAP-системы",
        "Хранилища данных (Data Warehouse)",
        "Трансакционные системы (OLTP)",
        "Аналитические приложения (BI)"
    ],
    correct: 2,
    explanation: "Основание пирамиды Gartner занимают транзакционные (OLTP) системы, которые управляют текущими операциями и являются источником первичных детальных данных для всех вышестоящих уровней аналитики."
},
{
    question: "Какая характеристика НЕ относится к ХРАНИЛИЩУ ДАННЫХ (Data Warehouse) по определению Инмона?",
    answers: [
        "Предметная ориентация (организация вокруг ключевых областей бизнеса)",
        "Интегрированность (данные приведены к единым стандартам)",
        "Ориентация на высокочастотные операции обновления",
        "Хронологичность (хранение исторических данных с привязкой ко времени)"
    ],
    correct: 2,
    explanation: "Хранилище данных характеризуется стабильностью: данные добавляются, но редко изменяются или удаляются. Высокочастотные операции обновления — это признак OLTP-систем в основании пирамиды."
},
{
    question: "Какой из критериев НЕ является обязательным для отнесения ИС к АНАЛИТИЧЕСКИМ ПРИЛОЖЕНИЯМ?",
    answers: [
        "Структуризация и автоматизация процессов улучшения бизнеса",
        "Исключительная ориентация на обработку транзакций в реальном времени",
        "Поддержка аналитических функций (тренды, прогнозирование)",
        "Автономность и способность к интеграции с OLTP-системами"
    ],
    correct: 1,
    explanation: "Аналитические приложения ориентированы на анализ, а не на обработку транзакций. Ориентация на обработку транзакций (OLTP) — это как раз критерий систем-источников в основании пирамиды."
},
{
    question: "Что является ключевой инновацией методологии BSC (Сбалансированной системы показателей)?",
    answers: [
        "Фокус исключительно на финансовых показателях прибыли",
        "Использование только ретроспективных, «отстающих» индикаторов",
        "Расширенный набор показателей, включая нефинансовые перспективы",
        "Отказ от интеграции с системами бизнес-интеллекта"
    ],
    correct: 2,
    explanation: "Ключевая инновация BSC — расширение набора измеряемых показателей за рамки финансовых. Система оценивает четыре перспективы: финансы, клиенты, внутренние процессы, обучение и развитие."
},
{
    question: "Чем СИСТЕМА БИЗНЕС-ИНТЕЛЛЕКТА (BI) принципиально отличается от АНАЛИТИЧЕСКОГО ПРИЛОЖЕНИЯ?",
    answers: [
        "BI-система всегда стоит ниже в аналитической пирамиде",
        "BI-система — это инструмент общего назначения для гибкого анализа, а приложение — готовое решение для конкретной задачи",
        "Аналитические приложения не используют данные из хранилищ",
        "Только BI-системы способны к прогнозной аналитике"
    ],
    correct: 1,
    explanation: "BI-система — это технологическая платформа общего назначения (набор инструментов). Аналитическое приложение — это готовый, предметно-ориентированный продукт, использующий технологии BI для решения конкретной бизнес-задачи (например, BSC)."
}
];
...
},
{
    ...
    { term: "БАЗОВЫЕ ИНФОРМАЦИОННЫЕ ТЕХНОЛОГИИ ИС", definition: "Ключевые технологические инструменты, составляющие основу построения ИС: технологии БД, текстового поиска и Web-технологии." },
{ term: "ФУНКЦИИ ИС", definition: "Основные информационные процессы, реализуемые системой: ввод, обработка, вывод информации и обратная связь." },
{ term: "ИНФОРМАЦИОННЫЕ РЕСУРСЫ ИС", definition: "«Сырьё» и продукт работы ИС: данные (для БД), документы, XML-файлы." },
{ term: "ЛИНГВИСТИЧЕСКИЕ РЕСУРСЫ ИС", definition: "Словари, тезаурусы, обеспечивающие представление информации и взаимодействие с пользователем." },
{ term: "ИНТЕНСИОНАЛЬНАЯ МОДЕЛЬ (Интенсионал)", definition: "Модель высокого уровня абстракции, описывающая структуру и типы сущностей предметной области. Выражается в виде метаданных и играет директивную роль." },
{ term: "ЭКСТЕНСИОНАЛЬНАЯ МОДЕЛЬ (Экстенсионал)", definition: "Конкретное, изменяющееся во времени наполнение модели — совокупность экземпляров сущностей и связей, соответствующих типам из интенсионала." },
{ term: "СТРУКТУРИРОВАННЫЕ МОДЕЛИ ДАННЫХ", definition: "Модели с чёткой, строго типизированной организацией. Основной принцип — явное разделение схемы (интенсионала) и данных (экстенсионала)." },
    { term: "СЛАБОСТРУКТУРИРОВАННЫЕ МОДЕЛИ ДАННЫХ", definition: "Модели с гибкой организацией, где строгая типизация не обязательна. Акцент на данных, интенсионал отсутствует или не является директивным." },
{ term: "СТРУКТУРИРОВАННАЯ ЗАДАЧА", definition: "Полностью формализуемая задача, где все элементы и связи известны. Может быть решена по точному алгоритму. Цель ИС — полная автоматизация (пример: расчёт зарплаты)." },
{ term: "ИС ОПЕРАЦИОННОГО УРОВНЯ", definition: "Информационные системы, обслуживающие исполнителей. Решают высокоструктурированные, повторяющиеся задачи по обработке текущих транзакций (пример: учёт продаж, накладных)." },
{ term: "ФАЙЛ-СЕРВЕРНАЯ АРХИТЕКТУРА", definition: "Архитектура ИС, где файлы БД хранятся на сервере, а СУБД и приложение — на каждом клиенте. Недостаток: высокий сетевой трафик из-за передачи файлов целиком для обработки на клиенте." },
{ term: "КЛИЕНТ-СЕРВЕРНАЯ АРХИТЕКТУРА", definition: "Архитектура с чётким разделением функций: сервер (back-end) хранит БД и выполняет СУБД, клиент (front-end) обеспечивает интерфейс. Сеть передаёт только результаты запросов." },
{ term: "АНАЛИТИЧЕСКАЯ ПИРАМИДА GARTNER", definition: "Иерархическая модель, показывающая уровни ИС от первичных транзакционных систем (OLTP) в основании до аналитических приложений на вершине. Отражает движение от детальных данных к агрегированной информации для решений." },
{ term: "ХРАНИЛИЩЕ ДАННЫХ (Data Warehouse)", definition: "Централизованное, предметно-ориентированное хранилище интегрированных, неизменяемых исторических данных. «Единый источник истины» для анализа (по Инмону)." },
{ term: "ВИТРИНА ДАННЫХ (Data Mart)", definition: "Предметно-ориентированное подмножество хранилища данных, оптимизированное для аналитических запросов конкретного отдела или сферы бизнеса (например, витрина для отдела продаж)." },
{ term: "АНАЛИТИЧЕСКОЕ ПРИЛОЖЕНИЕ", definition: "ИС высшего уровня пирамиды Gartner. Автономный продукт, структурирующий и автоматизирующий процесс анализа для решения конкретной бизнес-задачи (например, BSC, бюджетирование)." },
{ term: "BSC (Balanced Scorecard)", definition: "Сбалансированная система показателей. Пример аналитического приложения для стратегического управления, использующая сбалансированный набор финансовых и нефинансовых показателей по четырём перспективам." },
{ term: "СИСТЕМА БИЗНЕС-ИНТЕЛЛЕКТА (BI)", definition: "Технологическая платформа общего назначения, предоставляющая инструменты (OLAP, отчётность, дашборды) для сбора, анализа и визуализации данных. Основа для создания аналитических приложений." }
];
...
{ term: "Технологии баз данных (БД)", definition: "Для работы со структурированной, фактографической информацией." },
{ term: "Обратная связь (функция ИС)", definition: "Использование обработанной информации для корректировки входных данных и процессов." },
{ term: "Технические ресурсы ИС", definition: "Аппаратное обеспечение (средства вычислительной техники)." },
{ term: "Метаресурсы", definition: "«Данные о данных», описывающие свойства основных информационных ресурсов." },
{ term: "Экстенсионал", definition: "Конкретные экземпляры (данные), соответствующие типам из интенсионала (например, строки в таблицах БД)." },
{ term: "Неструктурированная модель", definition: "Информация на естественном языке без явной машинно-читаемой структуры (например, текстовые файлы, письма)." },
{ term: "Формальная модель", definition: "Модель, основанная на строгих математических принципах, позволяющая выполнять логический вывод (например, онтологии)." },
{ term: "СОВРЕМЕННАЯ КОНЦЕПЦИЯ МОДЕЛИ ДАННЫХ", definition: "Понимание модели данных как инструмента (языка), состоящего из трёх компонентов: средств структурирования, операционных средств и средств поддержания целостности." },
{ term: "ОПЕРАЦИОННЫЕ СРЕДСТВА МОДЕЛИ ДАННЫХ", definition: "Часть модели данных, включающая языки и операции для манипулирования данными: операции обновления (вставка, удаление, модификация) и операции запроса (поиска)." },
{ term: "РЕСУРСЫ ПЕРВОЙ КАТЕГОРИИ (Основные)", definition: "Информационные ресурсы ИС, непосредственно используемые пользователями для решения задач. Примеры: данные в таблицах, документы, изображения (экстенсионал)." },
{ term: "МЕТАРЕСУРСЫ (Метаданные)", definition: "Ресурсы второй категории в ИС. Это «данные о данных», описывающие свойства, структуру и правила управления основными ресурсами (интенсионал)." },
{ term: "ПРОЦЕССНЫЙ ПОДХОД", definition: "Методология управления, при которой организация рассматривается как совокупность взаимосвязанных бизнес-процессов, создающих ценность для потребителя, а не как набор функциональных отделов." },
{ term: "IDEF0 (Functional Modeling)", definition: "Методология функционального моделирования, представляющая процесс как блок-функцию с интерфейсными дугами: Вход, Управление, Выход, Механизм. Отвечает на вопрос «ЧТО делается?»." },
{ term: "IDEF3 (Process Description Capture)", definition: "Методология описания процессов, фокусирующаяся на последовательности и сценариях выполнения работ во времени. Использует действия, связи и соединения (И, ИЛИ, XOR). Отвечает на вопрос «КАК выполняется?»." },
{ term: "DFD (Data Flow Diagram)", definition: "Диаграмма потоков данных. Методология, моделирующая движение информации между процессами, внешними сущностями и хранилищами данных. Отвечает на вопрос «КУДА движутся данные?»." },
{ term: "ИС ОПЕРАЦИОННОГО УРОВНЯ (TPS)", definition: "Информационные системы, обслуживающие специалистов-исполнителей. Автоматизируют высокоструктурированные, повторяющиеся транзакции (обработка заказов, учёт продаж)." },
    { term: "КОРПОРАТИВНАЯ ИС (КИС)", definition: "Открытая интегрированная информационно-коммуникационная система, охватывающая все объекты, функции и уровни управления предприятием, построенная на единой платформе (напр., SAP, Oracle)." },
{ term: "Неструктурированная задача", definition: "Задача, для которой невозможно создать математическое описание и алгоритм. Решение принимается человеком на основе опыта и эвристик." },
{ term: "ИС тактического уровня", definition: "Системы поддержки менеджеров среднего звена. Решают частично-структурированные задачи анализа и контроля на уровне подразделений (MIS, DSS)." },
{ term: "Локальная (desktop) ИС", definition: "Архитектура, где БД, СУБД и приложение расположены на одном компьютере. Нет сетевого взаимодействия, невозможна коллективная работа." },
{ term: "Сервер приложений", definition: "Промежуточное звено в многозвенной (n-tier) клиент-серверной архитектуре. На нём выполняется бизнес-логика, что разгружает клиентов и сервер БД." },
{ term: "OLTP-система", definition: "Транзакционная система, расположенная в основании пирамиды Gartner. Источник первичных детальных данных о текущих операциях компании." },
{ term: "Интегрированность (хранилища данных)", definition: "Свойство Data Warehouse, означающее, что данные из разных источников приведены к единым стандартам, форматам и правилам именования." },
{ term: "Опережающий индикатор (в BSC)", definition: "Нефинансовый показатель, который позволяет прогнозировать будущие финансовые результаты на основе текущих действий (например, удовлетворённость клиентов)." },
{ term: "Ad-hoc анализ", definition: "Тип анализа «по запросу», не предопределённый заранее. Характерная возможность BI-систем, в отличие от жёстко структурированных аналитических приложений." }
    ];
...
{
    text: "К базовым информационным технологиям ИС относят: технологии [1], технологии [2] и [3]-технологии.",
    blanks: [
        { id: 1, correct: "БАЗ ДАННЫХ", options: ["БАЗ ДАННЫХ", "ТЕКСТОВОГО ПОИСКА", "ХРАНЕНИЯ", "ОБРАБОТКИ"] },
        { id: 2, correct: "ТЕКСТОВОГО ПОИСКА", options: ["АНАЛИТИЧЕСКИЕ", "ТЕКСТОВОГО ПОИСКА", "СЕТЕВЫЕ", "ВИЗУАЛИЗАЦИИ"] },
        { id: 3, correct: "WEB", options: ["WEB", "CLOUD", "MOBILE", "LOCAL"] }
    ]
},
{
    text: "Основные функции ИС — это [1], обработка, [2] и обратная связь.",
    blanks: [
        { id: 1, correct: "ВВОД", options: ["ВВОД", "ХРАНЕНИЕ", "КОПИРОВАНИЕ", "АНАЛИЗ"] },
        { id: 2, correct: "ВЫВОД", options: ["ВЫВОД", "УДАЛЕНИЕ", "КОНТРОЛЬ", "ПЕРЕДАЧА"] }
    ]
},
{
    text: "Ресурсы ИС включают технические, программные, информационные, лингвистические, [1] и метаресурсы.",
    blanks: [
        { id: 1, correct: "ЧЕЛОВЕЧЕСКИЕ", options: ["ЧЕЛОВЕЧЕСКИЕ", "ФИНАНСОВЫЕ", "ОРГАНИЗАЦИОННЫЕ", "МАТЕРИАЛЬНЫЕ"] }
    ]
},
{
    text: "[1] модель (интенсионал) описывает структуру предметной области, а [2] модель (экстенсионал) содержит конкретные данные, которые ей соответствуют.",
    blanks: [
        { id: 1, correct: "ИНТЕНСИОНАЛЬНАЯ", options: ["ИНТЕНСИОНАЛЬНАЯ", "ЭКСТЕНСИОНАЛЬНАЯ", "ЛОГИЧЕСКАЯ", "ФИЗИЧЕСКАЯ"] },
        { id: 2, correct: "ЭКСТЕНСИОНАЛЬНАЯ", options: ["ЭКСТЕНСИОНАЛЬНАЯ", "КОНЦЕПТУАЛЬНАЯ", "ВНЕШНЯЯ", "ПОЛЬЗОВАТЕЛЬСКАЯ"] }
    ]
},
{
    text: "В [1] моделях данных интенсионал является явным и директивным, а в [2] моделях он отсутствует или носит рекомендательный характер.",
    blanks: [
        { id: 1, correct: "СТРУКТУРИРОВАННЫХ", options: ["СТРУКТУРИРОВАННЫХ", "НЕСТРУКТУРИРОВАННЫХ", "ФОРМАЛЬНЫХ", "ЛОГИЧЕСКИХ"] },
        { id: 2, correct: "СЛАБОСТРУКТУРИРОВАННЫХ", options: ["СЛАБОСТРУКТУРИРОВАННЫХ", "ФОРМАЛЬНЫХ", "ИЕРАРХИЧЕСКИХ", "РЕЛЯЦИОННЫХ"] }
    ]
    },
{
    text: "Согласно современной концепции, модель данных — это инструмент, состоящий из трёх компонентов: средства [1] данных, [2] средства и средства поддержания [3].",
    blanks: [
        { id: 1, correct: "СТРУКТУРИРОВАНИЯ", options: ["СТРУКТУРИРОВАНИЯ", "ХРАНЕНИЯ", "ЗАЩИТЫ", "ВВОДА"] },
        { id: 2, correct: "ОПЕРАЦИОННЫЕ", options: ["ОПЕРАЦИОННЫЕ", "ГРАФИЧЕСКИЕ", "КОММУНИКАЦИОННЫЕ", "АНАЛИТИЧЕСКИЕ"] },
        { id: 3, correct: "ЦЕЛОСТНОСТИ", options: ["ЦЕЛОСТНОСТИ", "КОНФИДЕНЦИАЛЬНОСТИ", "ДОСТУПНОСТИ", "АКТУАЛЬНОСТИ"] }
    ]
},
{
    text: "В любой ИС обязательно поддерживаются две категории информационных ресурсов: основные данные ( [1] ) и [2] (метаданные).",
    blanks: [
        { id: 1, correct: "ЭКСТЕНСИОНАЛ", options: ["ЭКСТЕНСИОНАЛ", "ИНТЕНСИОНАЛ", "СХЕМА", "ШАБЛОН"] },
        { id: 2, correct: "МЕТАРЕСУРСЫ", options: ["МЕТАРЕСУРСЫ", "ТЕХНИЧЕСКИЕ РЕСУРСЫ", "ЧЕЛОВЕЧЕСКИЕ РЕСУРСЫ", "ПРОГРАММНЫЕ РЕСУРСЫ"] }
    ]
},
{
    text: "В нотации IDEF0 интерфейсная дуга [1] (сверху) задаёт правила выполнения функции, а дуга [2] (снизу) указывает на ресурсы, обеспечивающие её выполнение.",
    blanks: [
        { id: 1, correct: "УПРАВЛЕНИЯ", options: ["УПРАВЛЕНИЯ", "ВХОДА", "ВЫХОДА", "ОБРАТНОЙ СВЯЗИ"] },
        { id: 2, correct: "МЕХАНИЗМА", options: ["МЕХАНИЗМА", "РЕЗУЛЬТАТА", "ПОТОКА", "ТРИГГЕРА"] }
    ]
},
{
    text: "Методология [1] отвечает на вопрос «ЧТО делается?», методология [2] — «КАК выполняется?», а DFD — «[3] движутся данные?».",
    blanks: [
        { id: 1, correct: "IDEF0", options: ["IDEF0", "IDEF3", "BPMN", "UML"] },
        { id: 2, correct: "IDEF3", options: ["IDEF3", "DFD", "ERD", "IDEF0"] },
        { id: 3, correct: "КУДА", options: ["КУДА", "КОГДА", "ПОЧЕМУ", "ОТКУДА"] }
    ]
},
{
    text: "По уровням управления ИС делятся на операционные (обработка [1]), тактические (поддержка [2]) и стратегические (планирование [3]).",
    blanks: [
        { id: 1, correct: "ТРАНЗАКЦИЙ", options: ["ТРАНЗАКЦИЙ", "СТРАТЕГИЙ", "КРИЗИСОВ", "ПЕРСОНАЛА"] },
        { id: 2, correct: "ПРИНЯТИЯ РЕШЕНИЙ", options: ["ПРИНЯТИЯ РЕШЕНИЙ", "ТЕХНИЧЕСКОЙ ПОДДЕРЖКИ", "ФИНАНСОВОГО УЧЕТА", "МАРКЕТИНГА"] },
        { id: 3, correct: "ДОЛГОСРОЧНОГО", options: ["ДОЛГОСРОЧНОГО", "ОПЕРАТИВНОГО", "ЕЖЕДНЕВНОГО", "КРАТКОСРОЧНОГО"] }
    ]
    },
{
    text: "По признаку структурированности задачи делятся на три типа: [1] (полностью формализуемые), частично-структурированные и [2] (неформализуемые).",
    blanks: [
        { id: 1, correct: "СТРУКТУРИРОВАННЫЕ", options: ["СТРУКТУРИРОВАННЫЕ", "ТРАНЗАКЦИОННЫЕ", "АНАЛИТИЧЕСКИЕ", "ОПЕРАТИВНЫЕ"] },
        { id: 2, correct: "НЕСТРУКТУРИРОВАННЫЕ", options: ["НЕСТРУКТУРИРОВАННЫЕ", "СТРАТЕГИЧЕСКИЕ", "ТАКТИЧЕСКИЕ", "АВТОМАТИЗИРОВАННЫЕ"] }
    ]
},
{
    text: "В [1] архитектуре ИС файлы данных хранятся на сервере, а их обработка происходит на клиентских компьютерах, что создаёт высокий [2] трафик.",
    blanks: [
        { id: 1, correct: "ФАЙЛ-СЕРВЕРНОЙ", options: ["ФАЙЛ-СЕРВЕРНОЙ", "КЛИЕНТ-СЕРВЕРНОЙ", "ЛОКАЛЬНОЙ", "МНОГОЗВЕННОЙ"] },
        { id: 2, correct: "СЕТЕВОЙ", options: ["СЕТЕВОЙ", "ТРАНЗАКЦИОННЫЙ", "АНАЛИТИЧЕСКИЙ", "ВНУТРЕННИЙ"] }
    ]
},
{
    text: "В клиент-серверной архитектуры [1] отвечает за хранение данных и их обработку, а [2] — за предоставление пользовательского интерфейса.",
    blanks: [
        { id: 1, correct: "СЕРВЕР", options: ["СЕРВЕР", "КЛИЕНТ", "ШЛЮЗ", "КОММУТАТОР"] },
        { id: 2, correct: "КЛИЕНТ", options: ["КЛИЕНТ", "ХАБ", "МОДЕМ", "СЕРВЕР"] }
    ]
},
{
    text: "Основанием аналитической пирамиды Gartner являются [1] системы, а её вершину занимают [2] приложения.",
    blanks: [
        { id: 1, correct: "ТРАНЗАКЦИОННЫЕ (OLTP)", options: ["ТРАНЗАКЦИОННЫЕ (OLTP)", "ХРАНИЛИЩА ДАННЫХ", "ВИТРИНЫ ДАННЫХ", "OLAP-СИСТЕМЫ"] },
        { id: 2, correct: "АНАЛИТИЧЕСКИЕ", options: ["АНАЛИТИЧЕСКИЕ", "ОПЕРАЦИОННЫЕ", "ФАЙЛ-СЕРВЕРНЫЕ", "ТРАНЗАКЦИОННЫЕ"] }
    ]
},
{
    text: "Хранилище данных (Data Warehouse) характеризуется предметной ориентацией, интегрированностью, хронологичностью и [1]. BSC-система — это пример аналитического приложения, которое использует сбалансированный набор показателей, включая [2] и нефинансовые перспективы.",
    blanks: [
        { id: 1, correct: "СТАБИЛЬНОСТЬЮ", options: ["СТАБИЛЬНОСТЬЮ", "ВЫСОКОЙ ЧАСТОТОЙ ОБНОВЛЕНИЙ", "РАЗРОЗНЕННОСТЬЮ", "ОРИЕНТАЦИЕЙ НА ТРАНЗАКЦИИ"] },
        { id: 2, correct: "ФИНАНСОВЫЕ", options: ["ФИНАНСОВЫЕ", "ТЕХНИЧЕСКИЕ", "КАДРОВЫЕ", "ЛОГИСТИЧЕСКИЕ"] }
    ]
}
...
function shuffleQuestions() {
    // Создаем новый массив со всеми вопросами и перемешиваем его
    ...
    // Берем первые N вопросов (или все, если нужно)
    shuffledQuestions = allQuestions.slice(0, 10); // или allQuestions.slice() если нужны все
    
    // Сбросить на первый вопрос
    currentQuestionIndex = 0;
    loadQuestion(currentQuestionIndex);
    
    showNotification('Вопросы перемешаны! Выбраны новые случайные вопросы.', 'success');
    saveProgress();
}
